...
if select_category != "District Comparison" and select_category != 'Key Trends' :
    ...
    if select_category == 'Yearly Data (Population)' :
        ...
        with map2:
            st.markdown("<h4 style='text-align: center; color: black;'>Top 10 Neighborhoods</h4>", unsafe_allow_html=True)
...
if select_category != "District Comparison" :
    ...
    if select_category == "Key Trends":
        ...
        with col1: 
            ...
            df_sum.columns = ["District.Name","Year","Population"]
            st.markdown("<h5 style='text-align: center; color: black;'>Population By District</h5>", unsafe_allow_html=True)
            fig = px.line(df_sum, x="Year", y="Population", color="District.Name",
            ...
            st.markdown("<h5 style='text-align: center; color: black;'>Immigrants By Year</h5>", unsafe_allow_html=True)
        ...
        with col2:
            ...
            fig = px.line(df_unemployment_sum, x="Year", y="Unemployment", color="District.Name",
        ...
        with col1:
            ...
            df_population_sum.columns = ["District.Name","Number"]
            st.markdown("<h5 style='text-align: center; color: black;'>Population By District</h5>", unsafe_allow_html=True)            
            fig = px.bar(df_population_sum, x="District.Name", y="Number", color="District.Name",
                        hover_name="District.Name",  color_discrete_sequence=px.colors.sequential.Aggrnyl)
            fig.update_layout(
                plot_bgcolor="White",
                margin=dict(t=10,l=10,b=100,r=10),
                showlegend= False
        ...
        with col2:
            ...
            fig = px.bar(df_population_sum, x='Number', y='Age',
        ...
        with col3:
            ...
            df_death_sum.columns = ["Age","Number"]
            fig = px.bar(df_death_sum, x="Number", y="Age", color="Age", color_discrete_sequence=px.colors.sequential.Aggrnyl)
            fig.update_layout(
                plot_bgcolor="White",
                margin=dict(t=10,l=10,b=100,r=10)
            )
        ...
        with col1:
            ...
            df_unemployment_sum.columns = ["District.Name","Population"]
            st.markdown("<h5 style='text-align: center; color: black;'>Unemployment By District</h5>", unsafe_allow_html=True)
            fig = px.bar(df_unemployment_sum, x="District.Name", y="Population", color="District.Name",
                        hover_name="District.Name", color_discrete_sequence=px.colors.sequential.Aggrnyl)
            fig.update_layout(
                plot_bgcolor="White",
                margin=dict(t=10,l=10,b=100,r=10),
        ...
        with col2:
            ...
            fig = px.bar(df_age_sum, x='Number', y='Age',
            color='Age', color_discrete_sequence=px.colors.sequential.Aggrnyl)
            fig.update_layout(
                plot_bgcolor="White",
                margin=dict(t=10,l=10,b=100,r=10)
        ...
        # with col1:
            ...
            df_sum.columns = ["District.Name","Population"]
            st.markdown("<h5 style='text-align: center; color: black;'>Nationality By District</h5>", unsafe_allow_html=True)
            fig = px.bar(df_sum, x="District.Name", y="Population", color="District.Name",
                        hover_name="District.Name", color_discrete_sequence=px.colors.sequential.Aggrnyl)
            fig.update_layout(
                plot_bgcolor="White",
